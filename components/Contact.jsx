...
export default function Contact() {
  return (
    <section id="contact" className="relative z-30 bg-black min-h-screen flex flex-col justify-center border-t border-white/10 overflow-hidden">
      <div className="max-w-[1600px] mx-auto w-full px-6 md:px-12 flex flex-col md:flex-row pt-24 pb-12 md:py-24 gap-12 lg:gap-24 relative z-10">
        ...
        <div className="w-full md:w-5/12 flex flex-col justify-between relative z-10">
          ...
          >
            ...
            <h2 className="text-5xl md:text-[6rem] lg:text-[9rem] font-black text-white tracking-tighter uppercase leading-[0.9]">
              SAY<br />HELLO.
            </h2>
          </motion.div>
          ...
          >
            ...
            <a href="https://github.com/muneebtahir-12" target="_blank" rel="noreferrer" className="hover:text-[#84cc16] transition-colors py-2 border-b border-zinc-700 w-fit">GitHub</a>
            <a href="https://linkedin.com/in/muhammad-muneeb-tahir-2298aa344" target="_blank" rel="noreferrer" className="hover:text-[#84cc16] transition-colors py-2 border-b border-zinc-700 w-fit">LinkedIn</a>
